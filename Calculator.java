...
public class Calculator implements ActionListener{
    ...
    JLabel copyrightLabel = new JLabel("© 2025 RaboWorks.", SwingConstants.CENTER);
    ...
    Calculator(){
        ...
        copyrightLabel.setBounds(50, 410, 300, 30);
        copyrightLabel.setFont(new Font("Courier", Font.BOLD, 16));
